...
<div class="container mar_t200 mar_t200_ts">
	...
	<form class="form-signin" role="form" action="/fs/wxuser/register" method="post" class="form-horizontal">
			<h2 class="mar_b20" style="text-align: center;">欢迎注册</h2>
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">公司</span></span>
					<input class="form-control" id="company" name="company" type="text" maxlength=50 placeholder="请输入手机号码"/>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">姓名</span></span>
					<input class="form-control" id="name" name="name" type="text" maxlength=30 placeholder="请输入手机号码"/>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">职位</span></span>
					<input class="form-control" id="job" name="job" type="text" maxlength=50 placeholder="请输入手机号码"/>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
