...
<body style="margin-top: 50px;">
		...
		<div style="margin-top: 30px;float: left;width: 100%;">
			<form action="/fs/xml/edit" method="post">
				<input type="hidden" name="sn" value="${xmlInfo.sn }"/>
				<input type="hidden" name="versionNum" value="${xmlInfo.versionNum }"/>
				<table class="table">
					<tr>
						<td>名称：</td>
						<td><input type="text" class="form-control" name="name" value="${xmlInfo.name }" maxlength="15" placeholder="请输入名称"/></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div style="width: 99%;float: left;">
								<input type="hidden" id="xmlFileSn" name="xmlFileSn" value="${xmlInfo.xmlFileSn }"/>
								<input id="file_upload1" name="file_upload1" type="file" /><br>
								<span id="xmlFileSn_namedisplay">${xmlInfo.xmlFileName }</span>
					   		</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div style="width: 99%;float: left;">
								<input type="hidden" id="datFileSn" name="datFileSn" value="${xmlInfo.datFileSn }"/>
								<input id="file_upload2" name="file_upload2" type="file" /><br>
								<span id="datFileSn_namedisplay">${xmlInfo.datFileName }</span>
						   	</div>
						</td>
					</tr>
