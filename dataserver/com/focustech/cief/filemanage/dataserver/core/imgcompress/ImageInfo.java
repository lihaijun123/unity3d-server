 ...
 * <p>
 * Written by <a href="mailto:marcoschmidt@users.sourceforge.net">Marco
 * Schmidt</a>.
 * <p>
...
public class ImageInfo {
	 ...
	 * with PNG, but ImageInfo is currently not able to extract those.
	 */
	 ...
	 */
	private static final String[] FORMAT_NAMES = { "JPG", "GIF", "PNG", "BMP",
	 ...
	 * {@link java.io.RandomAccessFile} implements
	 *
	...
	private boolean checkSwf() throws IOException {
		// get rid of the last byte of the signature, the byte of the version
		// and 4 bytes of the size
		byte[] a = new byte[6];
		if (read(a) != a.length) {
			return false;
		}
